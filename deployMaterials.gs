...
const DOC_LOG_FOLDER_PROPERTY = 'DOC_LOG_FOLDER_ID';
const DOC_LOG_FOLDER_ID = PropertiesService.getScriptProperties().getProperty(DOC_LOG_FOLDER_PROPERTY) || '';
...
const SCRIPT_PROPERTIES = Object.freeze({
  ...
  DOC_LOG_FOLDER_ID: DOC_LOG_FOLDER_PROPERTY,
...
function generateLinkedInDoc(targetFolder, metadata, jobUrl) {
  ...
  const linkedInFileName = `Candidate_LinkedIn_${rearPortion}`;
